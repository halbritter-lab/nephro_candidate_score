...
def get_filling_method(model, feature):
    filling_methods = pd.read_csv(f"training/raw/fill_missing_methods_{config_vars['creation_date']}.csv.gz")
...
def fill_missing_vals(df, model):
    ...
    median_values_train = pd.read_csv(f"training/train_test_data/median_values_train_{config_vars['data_prep_date']}.csv.gz")
