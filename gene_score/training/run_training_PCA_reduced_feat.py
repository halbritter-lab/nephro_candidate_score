...
# set percentage of variance explained by principal components
perc_var_exp = 95

# set names of selecte feature groups
...
# estimator = DecisionTreeClassifier(max_depth=1) #TODO: adapt max_depth
...
#     'min_samples_split': [40, 50, 60, 70, 80, 90, 100, 110, 120, 130],
...
# model = "DecisionTree"
# param_grid = {
#     'n_estimators': np.arange(200, 300, 25),
...
# model = "QDA"
# param_grid = {
#     'reg_param': np.logspace(-5, -3, 10), #[ 0, 0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0, 10, 100],
#     'tol': [1e-2, 0, 1e+2 ]
# }
...
#     'hidden_layer_sizes': [(10,), (20,), (30,), (40,), (50,), (50, 10), (50, 20)], # [(70,), (60,), (50,), (40,), (50, 10), (50, 20)],
#     'solver': ['lbfgs'],
...
# model = "SVM"
# param_grid = {
#     'C': np.logspace(0, 4, 13),
#     'kernel': ['rbf'],
#     'gamma': np.logspace(-7, -1, 15)
# }
