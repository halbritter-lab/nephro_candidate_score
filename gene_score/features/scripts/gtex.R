...
write.csv(rna_tissue_gtex_nTPM_agg, paste0("gene_score/features/results/rna_tissue_gtex_nTPM_agg" , creation_date, ".csv"), row.names=FALSE)

# write results - tau values
write.csv(tau_df, paste0("gene_score/features/results/rna_tissues_gtex_nTPM_agg_tau_val" , creation_date, ".csv"), row.names=FALSE)
