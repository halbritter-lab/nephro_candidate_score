...
# write csv
clinvar_vep_anno.to_csv(f"features_labels/results/raw_features_clinvar_vars_kid-gen_2345_prefiltered_chr{chrom}_{current_date}.csv.gz", index=False, compression='gzip')
